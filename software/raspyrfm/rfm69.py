...
class Rfm69():
	...
	def __init__(self, cs = 0, gpio_int = 25):
		...
		for key in config:
			...
			#print("key: %5x"% key)
			#print("conf: %5x "% config[key])

		#print("set config ende")
		self.mode_standby()
	...
	def read_reg(self, reg):
		...
		#print("read_reg key: %5x "% (reg & 0x7F))
		#print("read_reg val: %5x "% (temp[1]))
		#print("read_reg")
		return int(temp[1])
